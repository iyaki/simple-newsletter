...
final readonly class HtmlResponse implements ResponseInterface
{
    ...
    public static function fromString(string $title, string $message, ?string $return = null, bool $ok = true): static
    {
        return new self($title, $message, $return, $ok);
    }

    public static function fromEndUserException(EndUserException $exception, ?string $return = null): static
    {
