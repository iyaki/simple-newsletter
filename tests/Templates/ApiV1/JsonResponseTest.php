...
test('fromString creates response with correct JSON body', function () {
...
test('fromEndUserException creates response with error title', function () {
...
test('getHeaders returns Content-Type application/json', function () {
...
test('json_encode failure returns empty JSON object', function () {
